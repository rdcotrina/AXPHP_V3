...
* Descripcion : ModalidadAdmisionView.js
* ---------------------------------------
*/ 

var ModalidadAdmisionView_ = Ajax.extend(function(){
    var _private = {};

    _private.config = {
        controller: "admision/ingreso/ModalidadAdmision/"
    };
    ...
    public.index = function(title){
        public.parent.send({
            ...
            fnCallback: function(data) {
                $("#" + tabs.MODA + "_CONTAINER").html(data);
                public.getGrid();
            }
        });
    };
    ...
    public.getGrid = function (){
        var pNew    = Tools.getPermiso("MODANEW");
        var pEdit   = Tools.getPermiso("MODAED");
        var pDelete = Tools.getPermiso("MODADE");
        
        $("#"+tabs.MODA+"grid").dataGrid({
            tScrollY: "200px",
            pDisplayLength: 25,
            ...
            tButtons:[{
                ...
                titulo: pNew.accion,
                class: pNew.theme,
                ajax: "Exe.ModalidadAdmisionView.formNew(this);"
            }],
            sExport:{
                ...
                columns:[
                    {title:lang.ModalidadAdmision.[FIELD] ,field:"accion",type: "string"},
                    {title:lang.ModalidadAdmision.[FIELD] ,field:"alias"}
                ]
            },
            pPaginate: true,
            sAxions: {
                buttons:[{
                    ...
                    class: pEdit.theme,
                    ajax: {
                        fn: "Exe.ModalidadAdmisionView.formEdit",
                    ...
                    class: pDelete.theme,
                    ajax: {
                        fn: "Exe.ModalidadAdmisionView.postDelete",
                        serverParams: "[DB_CAMPO]"
                    }
                }]
            },
    ...
    public.postNew = function(){
        public.parent.send({
            flag: 1,
            element: "#"+tabs.MODA+"btnSave",
            root: _private.config.controller + "postMantenimiento",
            form: "#"+tabs.MODA+"formNew",
            fnCallback: function(data) {
                if (parseInt(data.result) === 1) {
                    Tools.notify.ok({
                        content: lang.mensajes.MSG_3,
                        callback: function() {
                            Tools.closeModal("#" + tabs.MODA + "formEdit");
    ...
    public.postEdit = function(){
        public.parent.send({
            flag: 2,
            element: "#"+tabs.MODA+"btnEdit",
            root: _private.config.controller + "postMantenimiento",
            form: "#"+tabs.MODA+"formEdit",
            fnServerParams: function(sData) {
                sData.push({name: "_primaryKey", value: _private.primaryKey});
            },
            fnCallback: function(data) {
