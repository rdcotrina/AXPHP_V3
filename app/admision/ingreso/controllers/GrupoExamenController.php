...
* Descripcion : GrupoExamenController.php
* ---------------------------------------
*/ 
namespace Admision\Ingreso\Controllers;
    
use Admision\Ingreso\Filters\GrupoExamenFilter;

class GrupoExamenController extends \Vendor\Controller{

    use GrupoExamenFilter{
            GrupoExamenFilter::__construct as private __fConstruct;
        }
