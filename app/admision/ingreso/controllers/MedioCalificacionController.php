...
* Descripcion : MedioCalificacionController.php
* ---------------------------------------
*/ 
namespace Admision\Ingreso\Controllers;
    
use Admision\Ingreso\Filters\MedioCalificacionFilter;

class MedioCalificacionController extends \Vendor\Controller{

    use MedioCalificacionFilter{
            MedioCalificacionFilter::__construct as private __fConstruct;
        }
