    ...
    $.fn.extend({
        ...
        dataGrid: function(opt){
            ...
            _private.executeSorting = function(tthis,oSettings){
                ...
                oSettings.pDisplayStart = parseInt($('#paginate_' + oSettings.tObjectTable).find('ul.pagination').find('li.active').find('a').html()); //mysql -1
                $.method.sendAjax(oSettings);
            };
            ...
            _private.paginate = function(oSettings){
                ...
                if(oSettings.pPaginate && total > 0){
                    ...
                    var paginaActual = start; //mysql +1
                    ...
                    if (n) {
                        ...
                        if (!activo) {
                            $(this).find('a').click(function() {
                                oSettings.pDisplayStart = numero;//mysql numero -1
                                $.method.sendAjax(oSettings);
                            });
                        } else {
            ...
            _private.limitInferior = function(oSettings) {
                ...
                /*lineas obsoletas para SQL SERVER*/
...
//                }
            ...
            _private.numeracion = function(oSettings){
                if(oSettings.tNumbers){
                    ...
                    if(oSettings.pDisplayStart > 1){//se agrego para sql server
                        n = oSettings.pDisplayStart * oSettings.pDisplayLength;
                    }else{//se agrego para sql server
                        n = 1;//se agrego para sql server
                    }//se agrego para sql server
                    return n;
                }
            };
            ...
            _private.axionButtons = function(r, data, oSettings) {
                ...
                if(group instanceof Object && group !== ''){
                    ...
                    for (var i in group) {
                        ...
                        var tooltip = (group[i].tooltip !== undefined) ? group[i].tooltip : '';
